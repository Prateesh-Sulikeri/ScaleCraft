...
and three buttons: Validate, Submit, and Deep Check. The first two are the loop;
Deep Check is an optional AI review, and nothing in this chapter needs it. A
guided tour walks through it the first time you open the editor.
...
Structurally coherent is a specific claim, not a vague one: every component the
chapter requires is present and wired into the design, and every connection is
one the components at its two ends actually permit.
