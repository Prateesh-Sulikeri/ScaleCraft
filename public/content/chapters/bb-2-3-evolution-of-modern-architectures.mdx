...
stopped working. Part 3 is twenty-six chapters about those boxes, ordered as a
system acquires them rather than alphabetically. This chapter is that order:
