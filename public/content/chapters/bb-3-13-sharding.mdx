...
> [!NOTE]
> Before reading on: if replicas don't touch write throughput, and a bigger
> machine eventually runs out of room to grow, what's actually left? Commit to
> an answer.
...
Caption: each shard is a normal database holding a fraction of the rows -
