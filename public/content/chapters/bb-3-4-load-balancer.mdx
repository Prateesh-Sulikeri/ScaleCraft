...
<Walkthrough
  nodes={[
    { id: "client", kind: "component", componentId: "client", position: { x: 8, y: 50 } },
    { id: "lb", kind: "component", componentId: "load-balancer", position: { x: 42, y: 50 } },
    { id: "app1", kind: "component", componentId: "app-server", position: { x: 80, y: 22 } },
    { id: "app2", kind: "component", componentId: "app-server", position: { x: 80, y: 78 } },
  ]}
  edges={[
  ...
  steps={[
    ...
    {
      caption: "Round-robin picks App Server 1 to handle this request.",
      highlightNodeIds: ["lb", "app1"],
      highlightEdgeIds: ["req-app1"],
    },
    {
      caption: "App Server 1 answers. The client never knows which instance responded.",
      highlightNodeIds: ["app1"],
      highlightEdgeIds: [],
    },
    {
      caption: "The next request rotates to App Server 2 - round-robin spreads load evenly across every healthy instance.",
