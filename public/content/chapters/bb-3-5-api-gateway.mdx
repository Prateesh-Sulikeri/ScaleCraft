3.3 built a front door that routes by host and path, and drew the first line
around what a proxy does not do: authentication and rate limiting live
somewhere else. 3.4 added a load balancer, spreading traffic across identical,
