...
vi.mock("@/content/chapters", () => ({
  chapterRegistry: [{ id: "rwe-dummy-1" }],
}));

describe("RealWorldExtraction [chapterSlug]/lesson page", () => {
  it("renders ChapterReader for a known, authored slug", async () => {
    ...
    render(element);
    expect(screen.getByTestId("chapter-reader")).toHaveTextContent("real-world-extraction:known-slug");
  });
