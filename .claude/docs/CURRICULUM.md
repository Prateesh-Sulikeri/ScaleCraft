...
- Mastery per chapter = exercise pass + best exam attempt at or above the 80% pass
  threshold, unlimited attempts until passed (full-screen exam delivery, scored at
  submit, every option's explanation revealed on the results screen - see
  [[QUIZ_FRAMEWORK]] §1 and `.claude/docs/pending-quiz-ui.md` addendum).
